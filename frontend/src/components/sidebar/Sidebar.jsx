  ...
  export const Sidebar = () => {
    ...
    return (
      <div
        className={`relative sm:w-[50vw] md:w-[35vw] lg:w-[30vw] xl:w-[20vw] w-full bg-white  border-r border-slate-500 pt-2 pl-3 flex flex-col duration-1000 transition-all  ${
